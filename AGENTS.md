...
| `sidecar/src/teachDispatchRegistry.mjs` | ~110 | Active background-build registry: prevents duplicate per-topic dispatches, coordinates cancellation completion, and removes only lesson files created during a cancelled dispatch. |
